...
macro(WEBKIT_BUILD_PDFJS_GRESOURCES _derived_sources_dir)
    ...
    add_custom_command(
        ...
        COMMAND ${CMAKE_SOURCE_DIR}/Tools/glib/fix-glib-resource-deps-target ${_derived_sources_dir}/PdfJSGResourceBundle.deps ${_derived_sources_dir}/PdfJSGResourceBundle.xml ${CMAKE_BINARY_DIR}
        VERBATIM
    )
    ...
    add_custom_command(
        ...
        COMMAND ${CMAKE_SOURCE_DIR}/Tools/glib/fix-glib-resource-deps-target ${_derived_sources_dir}/PdfJSGResourceBundleExtras.deps ${_derived_sources_dir}/PdfJSGResourceBundleExtras.xml ${CMAKE_BINARY_DIR}
        VERBATIM
    )
endmacro()
