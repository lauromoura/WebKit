macro(WEBKIT_BUILD_INSPECTOR_GRESOURCES _derived_sources_dir)
    ...
    add_custom_command(
        ...
        COMMAND ${CMAKE_SOURCE_DIR}/Tools/glib/fix-glib-resource-deps-target ${_derived_sources_dir}/InspectorGResourceBundle.deps ${_derived_sources_dir}/InspectorGResourceBundle.xml ${CMAKE_BINARY_DIR}
        VERBATIM
    )
endmacro()
