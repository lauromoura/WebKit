macro(WEBKIT_BUILD_MODERN_MEDIA_CONTROLS_GRESOURCES _derived_sources_dir)
    ...
    add_custom_command(
        ...
        COMMAND ${CMAKE_SOURCE_DIR}/Tools/glib/fix-glib-resource-deps-target ${_derived_sources_dir}/ModernMediaControlsGResourceBundle.deps ${_derived_sources_dir}/ModernMediaControlsGResourceBundle.xml ${CMAKE_BINARY_DIR}
        VERBATIM
    )
endmacro()
